...
<main class="main" style="min-height: 100vh;">
  ...
  <li class="no-padding">
      <ul class="collapsible">
        <li>
          <a href="categories.php?id=10&sub_categories=21" class="collapsible-header"><i class="material-icons left">send</i>Dual Core Ist Gen </a>
  ...
  <li class="no-padding">
      <ul class="collapsible">
        <li>
          <a href="categories.php?id=10&sub_categories=22" class="collapsible-header"><i class="material-icons left">send</i>Dual Core 2nd Gen</a>
  ...
  <li class="no-padding">
      <ul class="collapsible">
        <li>
          <a href="categories.php?id=10&sub_categories=23" class="collapsible-header"><i class="material-icons left">send</i>Dual Core 3rd Gen </a>
  ...
  <li class="no-padding">
      <ul class="collapsible">
        <li>
          <a href="categories.php?id=10&sub_categories=24" class="collapsible-header"><i class="material-icons left">send</i>Dual Core 4th Gen </a>
